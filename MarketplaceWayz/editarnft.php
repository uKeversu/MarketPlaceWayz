...
<head>
  ...
  <title>Wayz - Edição de NFT</title>
  <link rel="stylesheet" href="css/home.css" />
  <link rel="stylesheet" href="css/editar-nft.css" />
...
<body class="bg-dark">
  ...
  <nav>
    ...
    <h2 class="text-light d-flex justify-content-center" id="alter-title">Change NFT value</h2>
...
*/
  ...
  /*          
   ...
   /*
            ...
            */
            ?> 
<form action="editanft.php" method="post">
<?php
    while($arquivo = mysqli_fetch_assoc($executa)) {
        ?> 
                   <div class="card-nfts d-flex mb-3">
                              <div class="col">
        ...
        <input type="number" class="form-control mb-3" id="nft-value-input" name ="vlr_nft" placeholder="NFT Value" autocomplete="off"/> 
        
        <button type="submit" id="btn-alter" class="btn btn-success">Save</button>
        </form>
      </div>
    </div>
  </div>
